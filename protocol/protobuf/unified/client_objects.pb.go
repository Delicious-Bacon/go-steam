...
const file_steammessages_client_objects_proto_rawDesc = "" +
	...
	"interfaces\x12$\n" +
	"\x0ebattery_temp_c\x18\x03 \x01(\x02R\fbatteryTempC\"\xc9\x0e\n" +
	...
	"\rtdp_limit_max\x18\x0f \x01(\x05R\vtdpLimitMax\x12(\n" +
	"\x10is_nis_supported\x18\x10 \x01(\bR\x0eisNisSupported\x12*\n" +
	"\x11nis_sharpness_min\x18\x11 \x01(\x05R\x0fnisSharpnessMin\x12*\n" +
	"\x11nis_sharpness_max\x18\x12 \x01(\x05R\x0fnisSharpnessMax\x12Q\n" +
	...
	"*is_dynamic_refresh_rate_in_steam_supported\x18\x18 \x01(\bR$isDynamicRefreshRateInSteamSupported\x12U\n" +
	"(is_split_scaling_and_filtering_supported\x18\x19 \x01(\bR#isSplitScalingAndFilteringSupported\x12[\n" +
	"\x1fsplit_scaling_filters_available\x18\x1a \x03(\x0e2\x14.ESplitScalingFilterR\x1csplitScalingFiltersAvailable\x12[\n" +
	"\x1fsplit_scaling_scalers_available\x18\x1b \x03(\x0e2\x14.ESplitScalingScalerR\x1csplitScalingScalersAvailable\x12(\n" +
	"\x10is_hdr_supported\x18\x1c \x01(\bR\x0eisHdrSupported\x12E\n" +
	" display_refresh_manual_hz_oc_max\x18\x1d \x01(\x05R\x1bdisplayRefreshManualHzOcMax\x12E\n" +
	"\x1fdisable_refresh_rate_management\x18\x1e \x01(\bR\x1cdisableRefreshRateManagement\"\x8a\v\n" +
	...
	"&allow_external_display_refresh_control\x18\b \x01(\bR\"allowExternalDisplayRefreshControl\x12$\n" +
	"\x0eis_hdr_enabled\x18\t \x01(\bR\fisHdrEnabled\x12q\n" +
	...
	"\x1dforce_hdr_wide_gammut_for_sdr\x18\x0f \x01(\b:\x04trueR\x18forceHdrWideGammutForSdr\x124\n" +
	"\x16allow_experimental_hdr\x18\x10 \x01(\bR\x14allowExperimentalHdr\x121\n" +
	"\x15sdr_to_hdr_brightness\x18\x16 \x01(\x02R\x12sdrToHdrBrightness\x125\n" +
	"\x17debug_force_hdr_support\x18\x12 \x01(\bR\x14debugForceHdrSupport\x12<\n" +
	"\x1bforce_hdr_10pq_output_debug\x18\x13 \x01(\bR\x17forceHdr10pqOutputDebug\x121\n" +
	"\x15is_display_oc_enabled\x18\x14 \x01(\bR\x12isDisplayOcEnabled\x12=\n" +
	"\x1bis_color_management_enabled\x18\x15 \x01(\bR\x18isColorManagementEnabled\"\xfd\n" +
	"\n" +
	...
	"\x15gpu_performance_level\x18\x0f \x01(\x0e2\x15.EGPUPerformanceLevel:\x1ek_EGPUPerformanceLevel_InvalidR\x13gpuPerformanceLevel\x12#\n" +
	"\rnis_sharpness\x18\x10 \x01(\x05R\fnisSharpness\x12J\n" +
	...
	"\n" +
	"refresh_hz\x18\x04 \x01(\x05R\trefreshHz\"\x96\x05\n" +
	...
	"\x0eis_vrr_enabled\x18\x0f \x01(\bR\fisVrrEnabled\x12$\n" +
	"\x0eis_hdr_capable\x18\x10 \x01(\bR\fisHdrCapable\x12$\n" +
	"\x0eis_hdr_enabled\x18\x11 \x01(\bR\fisHdrEnabled\x126\n" +
	...
	"\bloc_name\x18\x02 \x01(\tR\alocName\"\xe1\x04\n" +
	...
	"\tis_remote\x18\v \x01(\bR\bisRemote\x12\x1b\n" +
	...
	"\rdevkit_gameid\x18\x13 \x01(\tR\fdevkitGameid\",\n" +
